...
function runInterval() {
    async_1.default.waterfall([
        ...
        function (blocks, callback) {
            async_1.default.filter(blocks, function (block, mapCback) {
                api.rpcDaemon('getblockheaderbyheight', { height: block.height }, function (error, result) {
                    if (error) {
...
runInterval();
//# sourceMappingURL=blockUnlocker.js.map