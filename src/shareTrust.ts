...
type MinerShareInfo = {
    ...
    trusted: boolean,
    trustBeginSeconds: number,
    minUntrustedSeconds: number,
    untrustedShareThreshold: number,
    trustProbability: number,
    currentPenaltyMultiplier: number,
    penaltyStepUpBeginSeconds: number,
    penaltyStepDownBeginSeconds: number,
    probabilityStepWindowBeginSeconds: number,
    ipcRateBeginSeconds: number
};

type MinerShareTrust = {
    ip: { [key: string]: MinerShareInfo },
    address: { [key: string]: MinerShareInfo }
};

let minerShareTrust: MinerShareTrust = {
    ip: {},
    address: {}
};
...
function checkTrust(ip: string, address: string, difficulty: any) {
...
function setTrust(ip: string, address: string, shareValidated: boolean, isIPC: any) {
