...
//var apiInterfaces = require('./apiInterfaces')(config.daemon, config.wallet, config.api);
...
function runInterval() {
    async.waterfall([
        ...
        function (blocks: any, callback: any) {
            async.filter(blocks, function (block: any, mapCback: any) {
                api.rpcDaemon('getblockheaderbyheight', { height: block.height }, function (error: any, result: any) {
                    if (error) {
        ...
        function (blocks: any, callback: any) {
            var redisCommands = blocks.map(function (block: any) {
        ...
        function (blocks: any, callback: any) {
            var unlockedBlocksCommands: any = [];
            var payments: any = {};
